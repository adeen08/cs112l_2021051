/**
 * @file A4_2021051_2021598.cpp
 * @author Adeen Amir,Shehryar ahmed
 * @brief Assignment 4
 * @date 2022-04-29
 */
#include<iostream>
...
/**
 * @brief class which overloads all operators for use on strings
 * arr stores the sring
 * size is the size of char array
 * strsize is the size of the string
 */
class strings {
public:
    char* arr;
    ...
    //size of string stored in array
    int stringsize() {
        strsize = 0;
